...
import static ifn.user.JSONResponses.DENY_ACCESS;
import static ifn.user.JSONResponses.INCORRECT_REQUEST;
import static ifn.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws IfnException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Ifn.getBooleanProperty("ifn.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|IfnException e) {
