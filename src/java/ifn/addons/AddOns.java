...
import ifn.Ifn;
import ifn.http.APIServlet;
import ifn.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Ifn.getStringListProperty("ifn.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Ifn.getBooleanProperty("ifn.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Ifn.isDesktopApplicationEnabled() ? "ifndesktop.policy" : "ifn.policy");
