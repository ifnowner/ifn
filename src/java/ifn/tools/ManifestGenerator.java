...
import ifn.Ifn;
import ifn.env.service.IfnService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/ifn.manifest.mf", Ifn.class.getCanonicalName(), "./lib");
        String serviceClassName = IfnService_ServiceManagement.class.getCanonicalName();
