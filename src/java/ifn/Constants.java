...
public final class Constants {
    ...
    public static final String COIN_NAME = "IFN";
    public static final boolean isTestnet = Ifn.getBooleanProperty("ifn.isTestnet");
    public static final boolean isOffline = Ifn.getBooleanProperty("ifn.isOffline");
    public static final boolean isLightClient = Ifn.getBooleanProperty("ifn.isLightClient");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_IFX = 999999999;
    public static final long ONE_IFN = 100000000;
    //public static final long TRANSACTION_FEE = ONE_IFN / Ifn.getIntProperty("ifn.reductorFee", 1); //suse
    public static final long REDUCTOR_FEE = Ifn.getIntProperty("ifn.reductorFee", 1); //suse
    public static final long MAX_BALANCE_NQT =  MAX_BALANCE_IFX * ONE_IFN;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET =  MAX_BALANCE_IFX * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(Ifn.getIntProperty("ifn.maxRollback"), 720);
    //public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Ifn.getIntProperty("ifn.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Ifn.getIntProperty("ifn.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? Ifn.getIntProperty("ifn.testnetLeasingDelay", 1440) : 1440;
    //suse public static final int MAX_LEASING_PERIOD = 65535;
    public static final int MAX_LEASING_PERIOD = 65535;
    public static final long MIN_FORGING_BALANCE_NQT = 2000 * ONE_IFN;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = Ifn.getIntProperty("ifn.forgingDelay");
    public static final int FORGING_SPEEDUP = Ifn.getIntProperty("ifn.forgingSpeedup");
    ...
    static {
        int maxPrunableLifetime = Ifn.getIntProperty("ifn.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = Ifn.getBooleanProperty("ifn.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_IFN;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_IFN;

    public static final boolean correctInvalidFees = Ifn.getBooleanProperty("ifn.correctInvalidFees");
    ...
    public static final String SECRETPHRASE_PREFIX = "ifn";
