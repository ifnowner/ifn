...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws IfnException.NotValidException;

        Transaction build(String secretPhrase) throws IfnException.NotValidException;
    ...
    void validate() throws IfnException.ValidationException;
