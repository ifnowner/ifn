...
public abstract class IfnException extends Exception {

    protected IfnException() {
        super();
    }

    protected IfnException(String message) {
        super(message);
    }

    protected IfnException(String message, Throwable cause) {
        super(message, cause);
    }

    protected IfnException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends IfnException {
    ...
    public static final class IfnIOException extends IOException {

        public IfnIOException(String message) {
            super(message);
        }

        public IfnIOException(String message, Throwable cause) {
            super(message, cause);
        }
