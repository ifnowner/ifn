...
/**
 * Increase the value of currency units by paying IFN
 * <p>
 * Parameters
 * <ul>
 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link ifn.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link ifn.http.GetCurrencyFounders} API.
 */
