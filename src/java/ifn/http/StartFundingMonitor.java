...
import static ifn.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static ifn.http.JSONResponses.UNKNOWN_ACCOUNT;
import static ifn.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer IFN, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * IFN amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  IfnException        Unable to process request
     */
    @Override
