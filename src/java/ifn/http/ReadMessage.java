...
import static ifn.http.JSONResponses.NO_MESSAGE;
import static ifn.http.JSONResponses.PRUNED_TRANSACTION;
import static ifn.http.JSONResponses.UNKNOWN_TRANSACTION;
...
public final class ReadMessage extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        Transaction transaction = Ifn.getBlockchain().getTransaction(transactionId);
        if (transaction == null) {
