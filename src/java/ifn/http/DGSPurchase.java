...
import static ifn.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static ifn.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static ifn.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static ifn.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static ifn.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws IfnException {
        ...
        try {
            ...
            if (deliveryDeadline <= Ifn.getEpochTime()) {
