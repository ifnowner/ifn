...
/**
 * Issue a currency on the IFN blockchain
 * <p>
 * A currency is the basic block of the IFN Monetary System it can be exchanged with IFN, transferred between accounts,
 ...
 * For {@link ifn.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum IFN value per unit to allow the currency to become active
 * For {@link ifn.CurrencyType#RESERVABLE} currency
 ...
 * For {@link ifn.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link ifn.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link ifn.crypto.HashFunction algorithm} used for minting.
 * For {@link ifn.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link ifn.CurrencyType#EXCHANGEABLE} nor {@link ifn.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link ifn.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link ifn.CurrencyType#RESERVABLE} becomes active, in case it is {@link ifn.CurrencyType#CLAIMABLE} the IFN used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link ifn.CurrencyType#RESERVABLE} becomes active, in case it is non {@link ifn.CurrencyType#CLAIMABLE} the IFN used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link ifn.CurrencyType#MINTABLE} currency, the number of units per {@link ifn.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link ifn.http.CurrencyMint}<br>
 * </ul>
 *
 * @see ifn.CurrencyType
 * @see ifn.crypto.HashFunction
 */
