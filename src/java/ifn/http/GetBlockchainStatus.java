...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Ifn.APPLICATION);
        response.put("version", Ifn.VERSION);
        response.put("time", Ifn.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Ifn.getBlockchainProcessor().getMinRollbackHeight());
