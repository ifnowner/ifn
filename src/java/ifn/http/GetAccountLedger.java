 ...
 * account ledger tracks all account changes as determined by the ifn.ledgerAccounts,
 * ifn.ledgerLogUnconfirmed and ifn.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than ifn.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the ifn.maxAPIRecords property
 ...
 *     <tr>
 *       <td>WIN_BALANCE</td>
 *       <td>Change in the IFN balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *       <td>Change in the unconfirmed IFN balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  IfnException        Invalid request
     */
    @Override
