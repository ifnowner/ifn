...
import static ifn.http.JSONResponses.INCORRECT_HEIGHT;
import static ifn.http.JSONResponses.MISSING_HEIGHT;
...
public final class GetBlockId extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try {
            ...
            response.put("block", Long.toUnsignedString(Ifn.getBlockchain().getBlockIdAtHeight(height)));
            return response;
        } catch (RuntimeException e) {
            return INCORRECT_HEIGHT;
        }
