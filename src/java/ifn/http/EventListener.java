...
import ifn.Block;
import ifn.BlockchainProcessor;
import ifn.Db;
import ifn.Ifn;
import ifn.Transaction;
import ifn.TransactionProcessor;
 ...
 * has not been received within ifn.apiEventTimeout seconds.
 *
 * The maximum number of event users is specified by ifn.apiMaxEventUsers.
 */
class EventListener implements Runnable, AsyncListener, TransactionalDb.TransactionCallback {

    /** Maximum event users */
    static final int maxEventUsers = Ifn.getIntProperty("ifn.apiMaxEventUsers");

    /** Event registration timeout (seconds) */
    static final int eventTimeout = Math.max(Ifn.getIntProperty("ifn.apiEventTimeout"), 15);

    /** Blockchain processor */
    static final BlockchainProcessor blockchainProcessor = Ifn.getBlockchainProcessor();

    /** Transaction processor */
    static final TransactionProcessor transactionProcessor = Ifn.getTransactionProcessor();
     ...
     *
     * Ifn event listeners will be added for the specified events
     *
     * @param   eventRegistrations      List of Ifn event registrations
     ...
     *
     * @param   eventRegistrations      Ifn event registrations
     * @throws  EventListenerException  Invalid Ifn event
     */
    ...
    private class WinEventListener {
        ...
        /**
         * Add the Ifn listener for this event
         */
        ...
        /**
         * Remove the Ifn listener for this event
         */
        ...
        /**
         * Return the hash code for this Ifn event listener
         *
         * @return                  Hash code
         */
        @Override
        ...
        /**
         * Check if two Ifn events listeners are equal
         *
    ...
    static class EventRegistration {
         ...
         *
         * @param   event           Ifn listener event
        ...
        /**
         * Return the Ifn listener event
         *
         * @return                  Ifn listener event
         */
        public Enum<? extends Enum> getEvent() {
            return event;
        }
