...
import ifn.IfnException.IfnIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  IfnIOException      Maximum count exceeded
     */
    private void incCount(long c) throws IfnIOException {
        count += c;
        if (count > limit)
            throw new IfnIOException("Maximum size exceeded: " + count);
    }
}
