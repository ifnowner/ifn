...
//        return "IFN-" + Crypto.rsEncode(accountId);
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws IfnException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new IfnException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseWIN(String ifn) {
        return parseStringFraction(ifn, 8, Constants. MAX_BALANCE_IFX);
    }
