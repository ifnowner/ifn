...
/**
 * Java LogManager extension for use with Ifn
 */
public class IfnLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Ifn log manager
     *
     ...
     * done terminating the Ifn processes.
     */
    public IfnLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Ifn shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Ifn shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void ifnShutdown() {
        super.reset();
