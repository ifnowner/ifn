	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("IFN tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#winforum_news").rss("http://forum.winbit.com/index.php?action=.xml;type=rss", settings, NRS.newsLoaded);
      //$("#reddit_news").rss("http://www.reddit.com/r/IFN/.rss", settingsReddit, NRS.newsLoaded);
