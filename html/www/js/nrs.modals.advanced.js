...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initAdvancedModalFormValues = function($modal) {
		...
		$elems = NRS.initModalUIElement($modal, '.approve_transaction_amount_ifn', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		...
		$elems = NRS.initModalUIElement($modal, '.approve_min_balance_ifn', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
