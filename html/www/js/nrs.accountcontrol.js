...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount IFN",
			labelI18n: "amount_ifn",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumWIN",
			addonText: "IFN",
			addonI18n: "ifn_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_ifn', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['addonText'] = 'IFN';
		context['addonI18n'] = 'ifn_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_ifn', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
