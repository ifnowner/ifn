...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#loginButtons").find(".btn").click(function (e) {
        ...
        if (type == "account") {
            ...
            NRS.scanQRCode(readerId, function(text) {
                var ifnAddress = new IfnAddress();
                if (ifnAddress.set(text)) {
	...
	NRS.initPluginWarning = function() {
		if (NRS.activePlugins) {
			...
			html += "Plugins are not sandboxed or restricted in any way and have full accesss to your client system including your Ifn passphrase.";
			html += "</p>";
			...
			html += "you can loose your IFN! In doubt don't run plugins with accounts ";
			html += "used to store larger amounts of IFN now or in the future.";
			html += "</p>";
			html += "</div>";
