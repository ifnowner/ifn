    ...
    function initImpl() {
		...
		loadConstantsPromise.then(function() {
			...
			getStatePromise.then(function() {
				...
				$("#dgs_search_account_center").mask("IFN-****-****-****-*****");
			...
			if (firstRun) {
		    	...
		    	*/
				...
				if (NRS.defaultModules['send_token'] === false) {
					...
					$("button[data-i18n='send_ifn']").remove();
					NRS.logConsole('button[data-i18n=\'send_ifn\'] REMOVED');
